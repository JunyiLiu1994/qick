...
case class AxisSignalGenV6IO(N: Int) extends Bundle {
  ...
  s_axi_lite.aw.addr.addAttribute("X_INTERFACE_PARAMETER", "FREQ_HZ 99999985, CLK_DOMAIN d_1_zynq_ultra_ps_e_0_0_pl_clk0")
  ...
  s0_axis.payload.data.addAttribute("X_INTERFACE_PARAMETER", "FREQ_HZ 99999985, CLK_DOMAIN d_1_zynq_ultra_ps_e_0_0_pl_clk0")
