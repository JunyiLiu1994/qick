...
case class QickTop() extends Component {
  ...
  VivadoAxi4Stream.addInference(qick_processor_0_io.s_dma_axis, "qick_processor_0_s_dma_axis_i")
  VivadoAxi4Stream.addInference(qick_processor_0_io.m_dma_axis, "qick_processor_0_m_dma_axis_o")
  ...
  qickProcessor.io.allowOverride()
  ...
  axis_avg_buffer_0.io.allowOverride()
  ...
  axis_avg_buffer_0_io.m2_axis.setAsDirectionLess().assignDontCare()
  qick_processor_0_io.s_axis(0).setAsDirectionLess().assignDontCare()
  ...
  axis_avg_buffer_1.io.allowOverride()
  ...
  axis_avg_buffer_1_io.m2_axis.setAsDirectionLess().assignDontCare()
  qick_processor_0_io.s_axis(1).setAsDirectionLess().assignDontCare()
  ...
  axis_avg_buffer_2.io.allowOverride()
  ...
  axis_avg_buffer_2_io.m2_axis.setAsDirectionLess().assignDontCare()
  qick_processor_0_io.s_axis(2).setAsDirectionLess().assignDontCare()
  ...
  axis_avg_buffer_3.io.allowOverride()
  ...
  axis_avg_buffer_3_io.m2_axis.setAsDirectionLess().assignDontCare()
  qick_processor_0_io.s_axis(3).setAsDirectionLess().assignDontCare()
  ...
  axis_avg_buffer_4.io.allowOverride()
  ...
  axis_avg_buffer_4_io.m2_axis.setAsDirectionLess().assignDontCare()
  qick_processor_0_io.s_axis(4).setAsDirectionLess().assignDontCare()
  ...
  axis_avg_buffer_5.io.allowOverride()
  ...
  axis_avg_buffer_5_io.m2_axis.setAsDirectionLess().assignDontCare()
  qick_processor_0_io.s_axis(5).setAsDirectionLess().assignDontCare()
  ...
  axis_avg_buffer_6.io.allowOverride()
  ...
  axis_avg_buffer_6_io.m2_axis.setAsDirectionLess().assignDontCare()
  qick_processor_0_io.s_axis(6).setAsDirectionLess().assignDontCare()
  ...
  mr_buffer_et_0.io.allowOverride()
  ...
  axis_pfb_readout_v3_0.io.allowOverride()
  ...
  axis_readout_v2_0.io.allowOverride()
  ...
  axis_dyn_readout_v1_0.io.allowOverride()
  ...
  axis_signal_gen_v6_0_io.allowOverride()
  ...
  cd_dac2(axis_signal_gen_v6_0.io.m_axis.toFlow.delay(6).toStream >> axis_signal_gen_v6_0_io.m_axis)
  ...
  axis_signal_gen_v6_1_io.allowOverride()
  ...
  cd_dac2(axis_signal_gen_v6_1.io.m_axis.toFlow.delay(6).toStream >> axis_signal_gen_v6_1_io.m_axis)
  axis_signal_gen_v6_1.io.allowOverride()
  ...
  axis_tmux_v1_0.io.allowOverride()
  ...
  axis_cdcsync_v1_1.io.allowOverride()
  ...
  axis_sg_mux8_v1_0_io.allowOverride()
  ...
  cd_dac2(axis_sg_mux8_v1_0.io.m_axis.toFlow.delay(6).toStream >> axis_sg_mux8_v1_0_io.m_axis)
  ...
  axis_sg_mixmux8_v1_0.io.allowOverride()
  ...
  axis_sg_int4_v2_0.io.allowOverride()
  ...
  axis_sg_int4_v2_1.io.allowOverride()
  ...
  val sg_translator_0 = sg_translator()
  sg_translator_0.setDefinitionName("sg_translator_0")
  qickProcessor.io.m_axis(0) >> sg_translator_0.io.s_axis
  axis_signal_gen_v6_0.io.s1_axis.allowOverride()
  cd_dac2(sg_translator_0.io.m_gen_v6_axis >/-> axis_signal_gen_v6_0.io.s1_axis)
  sg_translator_0.io.aresetn := rst_dac2
  sg_translator_0.io.aclk := clk_dac2

  val sg_translator_1 = sg_translator(2)
  sg_translator_1.setDefinitionName("sg_translator_1")
  qickProcessor.io.m_axis(1) >> sg_translator_1.io.s_axis
  axis_sg_mux8_v1_0.io.s_axis.allowOverride()
  cd_dac2(sg_translator_1.io.m_mux4_axis.s2mPipe().m2sPipe() >/-> axis_sg_mux8_v1_0.io.s_axis)
  sg_translator_1.io.aresetn := rst_dac2
  sg_translator_1.io.aclk := clk_dac2

  val sg_translator_2 = sg_translator(0)
  sg_translator_2.setDefinitionName("sg_translator_2")
  axis_tmux_v1_0.io.m_axis(0).toStream.transmuteWith(sg_translator_2.io.s_axis.payload) >> sg_translator_2.io.s_axis
  axis_signal_gen_v6_1.io.s1_axis.allowOverride()
  cd_dac2(sg_translator_2.io.m_gen_v6_axis >/-> axis_signal_gen_v6_1.io.s1_axis)
  sg_translator_2.io.aresetn := rst_dac2
  sg_translator_2.io.aclk := clk_dac2

  val sg_translator_3 = sg_translator(0)
  sg_translator_3.setDefinitionName("sg_translator_3")
  axis_cdcsync_v1_1.io.m_axis(0) >> sg_translator_3.io.s_axis
  axis_sg_int4_v2_0.io.s1_axis.allowOverride()
  sg_translator_3.io.m_gen_v6_axis >> axis_sg_int4_v2_0.io.s1_axis
  sg_translator_3.io.aresetn := rst_dac3
  sg_translator_3.io.aclk := clk_dac3

  val sg_translator_4 = sg_translator(0)
  sg_translator_4.setDefinitionName("sg_translator_4")
  axis_cdcsync_v1_1.io.m_axis(1) >> sg_translator_4.io.s_axis
  axis_sg_int4_v2_1.io.s1_axis.allowOverride()
  sg_translator_4.io.m_gen_v6_axis >> axis_sg_int4_v2_1.io.s1_axis
  sg_translator_4.io.aresetn := rst_dac3
  sg_translator_4.io.aclk := clk_dac3

  val sg_translator_5 = sg_translator(2)
  sg_translator_5.setDefinitionName("sg_translator_5")
  axis_cdcsync_v1_1.io.m_axis(2) >> sg_translator_5.io.s_axis
  axis_sg_mixmux8_v1_0.io.s_axis.allowOverride()
  sg_translator_5.io.m_mux4_axis >> axis_sg_mixmux8_v1_0.io.s_axis
  sg_translator_5.io.aresetn := rst_dac3
  sg_translator_5.io.aclk := clk_dac3

  val sg_translator_6 = sg_translator(3)
  sg_translator_6.setDefinitionName("sg_translator_6")
  axis_tmux_v1_0.io.m_axis(2).toStream.queue(2, cd_dac2, cd_adc2).transmuteWith(sg_translator_6.io.s_axis.payload) >> sg_translator_6.io.s_axis
  axis_dyn_readout_v1_0.io.s0_axis.allowOverride()
  sg_translator_6.io.m_readout_axis >> axis_dyn_readout_v1_0.io.s0_axis
  sg_translator_6.io.aresetn := rst_adc2
  sg_translator_6.io.aclk := clk_adc2

  val sg_translator_7 = sg_translator(3)
  sg_translator_7.setDefinitionName("sg_translator_7")
  axis_tmux_v1_0.io.m_axis(3).toStream.transmuteWith(sg_translator_7.io.s_axis.payload) >> sg_translator_7.io.s_axis
  ...
  val ios = getAllIo.toList
  ios.foreach { io =>
    if(io.getName().contains("aclk") || io.getName().contains("areset")) {
      println(io.getName())
