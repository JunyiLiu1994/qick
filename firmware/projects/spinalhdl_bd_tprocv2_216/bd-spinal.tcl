...
proc create_root_design { parentCell } {
  ...
  set axis_resampler_2x1_v1_0 [ create_bd_cell -type module -reference AxisResampler axis_resampler_2x1_v1_0 ]

  # Create instance: axis_sg_mux8_v1_0, and set properties
  # set axis_sg_mux8_v1_0 [ create_bd_cell -type module -reference AxisSgMux8 axis_sg_mux8_v1_0 ]
...
\
  ...
  connect_bd_intf_net -intf_net axis_sg_mux8_v1_0_m_axis [get_bd_intf_pins axis_register_slice_1/s_axis] [get_bd_intf_pins qick_top/axis_sg_mux8_v1_0_m_axis]
  connect_bd_intf_net -intf_net axis_signal_gen_v6_0_m_axis [get_bd_intf_pins axis_register_slice_0/s_axis] [get_bd_intf_pins qick_top/axis_signal_gen_v6_0_m_axis]
  connect_bd_intf_net -intf_net axis_signal_gen_v6_1_m_axis [get_bd_intf_pins qick_top/axis_signal_gen_v6_1_m_axis] [get_bd_intf_pins axis_register_slice_2/s_axis]
  ...
  connect_bd_net -net rst_dac2_peripheral_aresetn [get_bd_pins rst_dac2/peripheral_aresetn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins qick_top/axis_sg_mux8_v1_0_aresetn] [get_bd_pins sg_translator_0/aresetn] [get_bd_pins sg_translator_1/aresetn] [get_bd_pins axis_resampler_2x1_v1_0/aresetn] [get_bd_pins sg_translator_7/aresetn] [get_bd_pins qick_top/axis_tmux_v1_0_aresetn] [get_bd_pins qick_top/axis_signal_gen_v6_0_aresetn] [get_bd_pins qick_top/axis_cdcsync_v1_1_s_axis_aresetn] [get_bd_pins qick_top/axis_signal_gen_v6_1_aresetn] [get_bd_pins axis_register_slice_2/aresetn] [get_bd_pins sg_translator_2/aresetn] [get_bd_pins axis_clock_converter_1/s_axis_aresetn] [get_bd_pins axis_clock_converter_3/m_axis_aresetn] [get_bd_pins qick_top/axis_readout_v3_0_aresetn] [get_bd_pins axis_register_slice_3/aresetn] [get_bd_pins axis_register_slice_4/aresetn] [get_bd_pins axis_register_slice_8/aresetn] [get_bd_pins axis_register_slice_6/aresetn] [get_bd_pins axis_register_slice_5/aresetn] [get_bd_pins axis_register_slice_10/aresetn] [get_bd_pins usp_rf_data_converter_0/s2_axis_aresetn] [get_bd_pins qick_top/axis_avg_buffer_1_s_axis_aresetn] [get_bd_pins qick_top/qick_processor_0_t_resetn] [get_bd_pins qick_top/rst_dac2]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_dac2 [get_bd_pins usp_rf_data_converter_0/clk_dac2] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins qick_top/axis_sg_mux8_v1_0_aclk_i] [get_bd_pins rst_dac2/slowest_sync_clk] [get_bd_pins sg_translator_0/aclk] [get_bd_pins sg_translator_1/aclk] [get_bd_pins axis_resampler_2x1_v1_0/aclk] [get_bd_pins sg_translator_7/aclk] [get_bd_pins qick_top/axis_tmux_v1_0_aclk] [get_bd_pins qick_top/axis_signal_gen_v6_0_aclk_i] [get_bd_pins qick_top/axis_cdcsync_v1_1_s_axis_aclk] [get_bd_pins qick_top/axis_signal_gen_v6_1_aclk_i] [get_bd_pins axis_register_slice_2/aclk] [get_bd_pins sg_translator_2/aclk] [get_bd_pins axis_clock_converter_1/s_axis_aclk] [get_bd_pins axis_clock_converter_3/m_axis_aclk] [get_bd_pins qick_top/axis_readout_v3_0_aclk_i] [get_bd_pins axis_register_slice_3/aclk] [get_bd_pins axis_register_slice_4/aclk] [get_bd_pins axis_register_slice_8/aclk] [get_bd_pins axis_register_slice_6/aclk] [get_bd_pins axis_register_slice_5/aclk] [get_bd_pins axis_register_slice_10/aclk] [get_bd_pins usp_rf_data_converter_0/s2_axis_aclk] [get_bd_pins qick_top/axis_avg_buffer_1_s_axis_aclk_i] [get_bd_pins qick_top/qick_processor_0_t_clk_i] [get_bd_pins clk_core/clk_in1] [get_bd_pins qick_top/clk_dac2]
