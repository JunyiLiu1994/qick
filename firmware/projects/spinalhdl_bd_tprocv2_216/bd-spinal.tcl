...
\
  ...
  connect_bd_intf_net -intf_net axis_register_slice_0_m_axis [get_bd_intf_pins qick_top/axis_signal_gen_v6_0_m_axis] [get_bd_intf_pins usp_rf_data_converter_0/s20_axis]
  connect_bd_intf_net -intf_net axis_register_slice_1_m_axis [get_bd_intf_pins qick_top/axis_sg_mux8_v1_0_m_axis] [get_bd_intf_pins usp_rf_data_converter_0/s21_axis]
  connect_bd_intf_net -intf_net axis_register_slice_2_m_axis [get_bd_intf_pins qick_top/axis_signal_gen_v6_1_m_axis] [get_bd_intf_pins usp_rf_data_converter_0/s22_axis]
  ...
  connect_bd_net -net rst_dac2_peripheral_aresetn [get_bd_pins rst_dac2/peripheral_aresetn]   [get_bd_pins qick_top/axis_sg_mux8_v1_0_aresetn] [get_bd_pins qick_top/axis_resampler_2x1_v1_0_aresetn] [get_bd_pins qick_top/axis_tmux_v1_0_aresetn] [get_bd_pins qick_top/axis_signal_gen_v6_0_aresetn] [get_bd_pins qick_top/axis_cdcsync_v1_1_s_axis_aresetn] [get_bd_pins qick_top/axis_signal_gen_v6_1_aresetn]   [get_bd_pins axis_clock_converter_3/m_axis_aresetn] [get_bd_pins qick_top/axis_readout_v3_0_aresetn]      [get_bd_pins usp_rf_data_converter_0/s2_axis_aresetn] [get_bd_pins qick_top/axis_avg_buffer_1_s_axis_aresetn] [get_bd_pins qick_top/qick_processor_0_t_resetn] [get_bd_pins qick_top/rst_dac2]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_dac2 [get_bd_pins usp_rf_data_converter_0/clk_dac2]   [get_bd_pins qick_top/axis_sg_mux8_v1_0_aclk_i] [get_bd_pins rst_dac2/slowest_sync_clk] [get_bd_pins qick_top/axis_resampler_2x1_v1_0_aclk] [get_bd_pins qick_top/axis_tmux_v1_0_aclk] [get_bd_pins qick_top/axis_signal_gen_v6_0_aclk_i] [get_bd_pins qick_top/axis_cdcsync_v1_1_s_axis_aclk] [get_bd_pins qick_top/axis_signal_gen_v6_1_aclk_i]   [get_bd_pins axis_clock_converter_3/m_axis_aclk] [get_bd_pins qick_top/axis_readout_v3_0_aclk_i]       [get_bd_pins usp_rf_data_converter_0/s2_axis_aclk] [get_bd_pins qick_top/axis_avg_buffer_1_s_axis_aclk_i] [get_bd_pins qick_top/qick_processor_0_t_clk_i] [get_bd_pins clk_core/clk_in1] [get_bd_pins qick_top/clk_dac2]
