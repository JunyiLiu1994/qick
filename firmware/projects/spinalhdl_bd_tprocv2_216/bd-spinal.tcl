...
\
  ...
  connect_bd_net -net rst_adc_peripheral_aresetn [get_bd_pins rst_adc2/peripheral_aresetn] [get_bd_pins sg_translator_6/aresetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins axis_broadcaster_2/aresetn] [get_bd_pins axis_broadcaster_3/aresetn] [get_bd_pins axis_broadcaster_4/aresetn] [get_bd_pins axis_broadcaster_5/aresetn] [get_bd_pins axis_clock_converter_1/m_axis_aresetn] [get_bd_pins axis_clock_converter_3/s_axis_aresetn] [get_bd_pins qick_top/axis_dyn_readout_v1_0_aresetn] [get_bd_pins qick_top/axis_pfb_readout_v3_0_aresetn] [get_bd_pins qick_top/axis_readout_v2_0_aresetn] [get_bd_pins axis_switch_ddr/aresetn] [get_bd_pins axis_switch_mr/aresetn] [get_bd_pins usp_rf_data_converter_0/m2_axis_aresetn] [get_bd_pins ddr4/aresetn] [get_bd_pins qick_top/axis_avg_buffer_0_s_axis_aresetn] [get_bd_pins qick_top/axis_avg_buffer_2_s_axis_aresetn] [get_bd_pins qick_top/axis_avg_buffer_3_s_axis_aresetn] [get_bd_pins qick_top/axis_avg_buffer_4_s_axis_aresetn] [get_bd_pins qick_top/axis_avg_buffer_5_s_axis_aresetn] [get_bd_pins qick_top/axis_avg_buffer_6_s_axis_aresetn] [get_bd_pins qick_top/mr_buffer_et_0_s00_axis_aresetn]
