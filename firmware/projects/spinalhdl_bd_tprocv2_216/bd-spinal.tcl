...
\
  ...
  connect_bd_intf_net -intf_net sg_translator_0_m_gen_v6_axis [get_bd_intf_pins axis_register_slice_3/S_AXIS] [get_bd_intf_pins qick_top/sg_translator_0_m_gen_v6_axis]
  connect_bd_intf_net -intf_net sg_translator_1_m_mux4_axis [get_bd_intf_pins axis_register_slice_4/S_AXIS] [get_bd_intf_pins qick_top/sg_translator_1_m_mux4_axis]
  connect_bd_intf_net -intf_net sg_translator_2_m_gen_v6_axis [get_bd_intf_pins qick_top/sg_translator_2_m_gen_v6_axis] [get_bd_intf_pins axis_register_slice_5/S_AXIS]
  ...
  connect_bd_net -net rst_dac2_peripheral_aresetn [get_bd_pins rst_dac2/peripheral_aresetn] [get_bd_pins qick_top/axis_register_slice_0_aresetn] [get_bd_pins qick_top/axis_register_slice_1_aresetn] [get_bd_pins qick_top/axis_sg_mux8_v1_0_aresetn] [get_bd_pins qick_top/axis_resampler_2x1_v1_0_aresetn] [get_bd_pins qick_top/axis_tmux_v1_0_aresetn] [get_bd_pins qick_top/axis_signal_gen_v6_0_aresetn] [get_bd_pins qick_top/axis_cdcsync_v1_1_s_axis_aresetn] [get_bd_pins qick_top/axis_signal_gen_v6_1_aresetn] [get_bd_pins qick_top/axis_register_slice_2_aresetn] [get_bd_pins axis_clock_converter_1/s_axis_aresetn] [get_bd_pins axis_clock_converter_3/m_axis_aresetn] [get_bd_pins qick_top/axis_readout_v3_0_aresetn] [get_bd_pins axis_register_slice_3/aresetn] [get_bd_pins axis_register_slice_4/aresetn] [get_bd_pins axis_register_slice_8/aresetn] [get_bd_pins axis_register_slice_6/aresetn] [get_bd_pins axis_register_slice_5/aresetn] [get_bd_pins axis_register_slice_10/aresetn] [get_bd_pins usp_rf_data_converter_0/s2_axis_aresetn] [get_bd_pins qick_top/axis_avg_buffer_1_s_axis_aresetn] [get_bd_pins qick_top/qick_processor_0_t_resetn] [get_bd_pins qick_top/rst_dac2]
  connect_bd_net -net rst_dac2_peripheral_reset [get_bd_pins rst_dac2/peripheral_reset] [get_bd_pins clk_core/reset]
  connect_bd_net -net rst_dac3_peripheral_aresetn [get_bd_pins rst_dac3/peripheral_aresetn] [get_bd_pins qick_top/axis_sg_mixmux8_v1_0_aresetn] [get_bd_pins qick_top/axis_cdcsync_v1_1_m_axis_aresetn] [get_bd_pins qick_top/axis_sg_int4_v2_0_aresetn] [get_bd_pins qick_top/axis_sg_int4_v2_1_aresetn] [get_bd_pins usp_rf_data_converter_0/s3_axis_aresetn] [get_bd_pins qick_top/rst_dac3]
