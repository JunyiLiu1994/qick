...
module QickTop (
  ...
  assign t_time_abs_o = qickProcessor_t_time_abs_o;
  assign pulse_sync_o = qickProcessor_pulse_sync_o;
  assign qnet_en_o = qickProcessor_qnet_en_o;
  assign qnet_op_o = qickProcessor_qnet_op_o;
  assign qnet_a_dt_o = qickProcessor_qnet_a_dt_o;
  assign qnet_b_dt_o = qickProcessor_qnet_b_dt_o;
  assign qnet_c_dt_o = qickProcessor_qnet_c_dt_o;
  assign qcom_en_o = qickProcessor_qcom_en_o;
  assign qcom_op_o = qickProcessor_qcom_op_o;
  assign qcom_dt_o = qickProcessor_qcom_dt_o;
  assign qp1_en_o = qickProcessor_qp1_en_o;
  assign qp1_op_o = qickProcessor_qp1_op_o;
  assign qp1_a_dt_o = qickProcessor_qp1_a_dt_o;
  assign qp1_b_dt_o = qickProcessor_qp1_b_dt_o;
  assign qp1_c_dt_o = qickProcessor_qp1_c_dt_o;
  assign qp1_d_dt_o = qickProcessor_qp1_d_dt_o;
  assign qp2_en_o = qickProcessor_qp2_en_o;
  assign qp2_op_o = qickProcessor_qp2_op_o;
  assign qp2_a_dt_o = qickProcessor_qp2_a_dt_o;
  assign qp2_b_dt_o = qickProcessor_qp2_b_dt_o;
  assign qp2_c_dt_o = qickProcessor_qp2_c_dt_o;
  assign qp2_d_dt_o = qickProcessor_qp2_d_dt_o;
  assign s_dma_axis_tready_o = qickProcessor_s_dma_axis_tready_o;
  assign m_dma_axis_tvalid_o = qickProcessor_m_dma_axis_tvalid_o;
  assign m_dma_axis_tdata_o = qickProcessor_m_dma_axis_tdata_o;
  assign m_dma_axis_tlast_o = qickProcessor_m_dma_axis_tlast_o;
  assign s_axi_awready = qickProcessor_s_axi_awready;
  assign s_axi_wready = qickProcessor_s_axi_wready;
  assign s_axi_bvalid = qickProcessor_s_axi_bvalid;
  assign s_axi_bresp = qickProcessor_s_axi_bresp;
  assign s_axi_arready = qickProcessor_s_axi_arready;
  assign s_axi_rvalid = qickProcessor_s_axi_rvalid;
  assign s_axi_rdata = qickProcessor_s_axi_rdata;
  assign s_axi_rresp = qickProcessor_s_axi_rresp;
  assign s0_axis_tready = qickProcessor_s0_axis_tready;
  assign s1_axis_tready = qickProcessor_s1_axis_tready;
  assign s2_axis_tready = qickProcessor_s2_axis_tready;
  assign s3_axis_tready = qickProcessor_s3_axis_tready;
  assign s4_axis_tready = qickProcessor_s4_axis_tready;
  assign s5_axis_tready = qickProcessor_s5_axis_tready;
  assign s6_axis_tready = qickProcessor_s6_axis_tready;
  assign s7_axis_tready = qickProcessor_s7_axis_tready;
  assign s8_axis_tready = qickProcessor_s8_axis_tready;
  assign s9_axis_tready = qickProcessor_s9_axis_tready;
  assign s10_axis_tready = qickProcessor_s10_axis_tready;
  assign s11_axis_tready = qickProcessor_s11_axis_tready;
  assign s12_axis_tready = qickProcessor_s12_axis_tready;
  assign s13_axis_tready = qickProcessor_s13_axis_tready;
  assign s14_axis_tready = qickProcessor_s14_axis_tready;
  assign s15_axis_tready = qickProcessor_s15_axis_tready;
  assign m0_axis_tvalid = qickProcessor_m0_axis_tvalid;
  assign m0_axis_tdata = qickProcessor_m0_axis_tdata;
  assign m1_axis_tvalid = qickProcessor_m1_axis_tvalid;
  assign m1_axis_tdata = qickProcessor_m1_axis_tdata;
  assign m2_axis_tvalid = qickProcessor_m2_axis_tvalid;
  assign m2_axis_tdata = qickProcessor_m2_axis_tdata;
  assign m3_axis_tvalid = qickProcessor_m3_axis_tvalid;
  assign m3_axis_tdata = qickProcessor_m3_axis_tdata;
  assign m4_axis_tvalid = qickProcessor_m4_axis_tvalid;
  assign m4_axis_tdata = qickProcessor_m4_axis_tdata;
  assign m5_axis_tvalid = qickProcessor_m5_axis_tvalid;
  assign m5_axis_tdata = qickProcessor_m5_axis_tdata;
  assign m6_axis_tvalid = qickProcessor_m6_axis_tvalid;
  assign m6_axis_tdata = qickProcessor_m6_axis_tdata;
  assign m7_axis_tvalid = qickProcessor_m7_axis_tvalid;
  assign m7_axis_tdata = qickProcessor_m7_axis_tdata;
  assign m8_axis_tvalid = qickProcessor_m8_axis_tvalid;
  assign m8_axis_tdata = qickProcessor_m8_axis_tdata;
  assign m9_axis_tvalid = qickProcessor_m9_axis_tvalid;
  assign m9_axis_tdata = qickProcessor_m9_axis_tdata;
  assign m10_axis_tvalid = qickProcessor_m10_axis_tvalid;
  assign m10_axis_tdata = qickProcessor_m10_axis_tdata;
  assign m11_axis_tvalid = qickProcessor_m11_axis_tvalid;
  assign m11_axis_tdata = qickProcessor_m11_axis_tdata;
  assign m12_axis_tvalid = qickProcessor_m12_axis_tvalid;
  assign m12_axis_tdata = qickProcessor_m12_axis_tdata;
  assign m13_axis_tvalid = qickProcessor_m13_axis_tvalid;
  assign m13_axis_tdata = qickProcessor_m13_axis_tdata;
  assign m14_axis_tvalid = qickProcessor_m14_axis_tvalid;
  assign m14_axis_tdata = qickProcessor_m14_axis_tdata;
  assign m15_axis_tvalid = qickProcessor_m15_axis_tvalid;
  assign m15_axis_tdata = qickProcessor_m15_axis_tdata;
  assign trig_0_o = qickProcessor_trig_0_o;
  assign trig_1_o = qickProcessor_trig_1_o;
  assign trig_2_o = qickProcessor_trig_2_o;
  assign trig_3_o = qickProcessor_trig_3_o;
  assign trig_4_o = qickProcessor_trig_4_o;
  assign trig_5_o = qickProcessor_trig_5_o;
  assign trig_6_o = qickProcessor_trig_6_o;
  assign trig_7_o = qickProcessor_trig_7_o;
  assign trig_8_o = qickProcessor_trig_8_o;
  assign trig_9_o = qickProcessor_trig_9_o;
  assign trig_10_o = qickProcessor_trig_10_o;
  assign trig_11_o = qickProcessor_trig_11_o;
  assign trig_12_o = qickProcessor_trig_12_o;
  assign trig_13_o = qickProcessor_trig_13_o;
  assign trig_14_o = qickProcessor_trig_14_o;
  assign trig_15_o = qickProcessor_trig_15_o;
  assign trig_16_o = qickProcessor_trig_16_o;
  assign trig_17_o = qickProcessor_trig_17_o;
  assign trig_18_o = qickProcessor_trig_18_o;
  assign trig_19_o = qickProcessor_trig_19_o;
  assign trig_20_o = qickProcessor_trig_20_o;
  assign trig_21_o = qickProcessor_trig_21_o;
  assign trig_22_o = qickProcessor_trig_22_o;
  assign trig_23_o = qickProcessor_trig_23_o;
  assign trig_24_o = qickProcessor_trig_24_o;
  assign trig_25_o = qickProcessor_trig_25_o;
  assign trig_26_o = qickProcessor_trig_26_o;
  assign trig_27_o = qickProcessor_trig_27_o;
  assign trig_28_o = qickProcessor_trig_28_o;
  assign trig_29_o = qickProcessor_trig_29_o;
  assign trig_30_o = qickProcessor_trig_30_o;
  assign trig_31_o = qickProcessor_trig_31_o;
  assign port_0_dt_o = qickProcessor_port_0_dt_o;
  assign port_1_dt_o = qickProcessor_port_1_dt_o;
  assign port_2_dt_o = qickProcessor_port_2_dt_o;
  assign port_3_dt_o = qickProcessor_port_3_dt_o;
  assign ps_debug_do = qickProcessor_ps_debug_do;
  assign t_debug_do = qickProcessor_t_debug_do;
  assign t_fifo_do = qickProcessor_t_fifo_do;
  assign c_time_usr_do = qickProcessor_c_time_usr_do;
  assign c_debug_do = qickProcessor_c_debug_do;
  assign c_time_ref_do = qickProcessor_c_time_ref_do;
  assign c_proc_do = qickProcessor_c_proc_do;
  assign c_port_do = qickProcessor_c_port_do;
  assign c_core_do = qickProcessor_c_core_do;
