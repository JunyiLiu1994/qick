...
// Component : QickTop
// Git hash  : 470002480f29a4e0dfcf54cede11e2f7fc13766c
...
module QickTop (
  ...
  input  wire          axis_avg_buffer_2_s_axi_aclk_i,
  input  wire          axis_avg_buffer_2_s_axi_aresetn,
  ...
  input  wire          axis_avg_buffer_2_s_axis_aclk_i,
  input  wire          axis_avg_buffer_2_s_axis_aresetn,
  input  wire          axis_avg_buffer_2_m_axis_aclk_i,
  input  wire          axis_avg_buffer_2_m_axis_aresetn,
  ...
  input  wire          axis_avg_buffer_3_s_axi_aclk_i,
  input  wire          axis_avg_buffer_3_s_axi_aresetn,
  ...
  input  wire          axis_avg_buffer_3_s_axis_aclk_i,
  input  wire          axis_avg_buffer_3_s_axis_aresetn,
  input  wire          axis_avg_buffer_3_m_axis_aclk_i,
  input  wire          axis_avg_buffer_3_m_axis_aresetn,
  ...
  input  wire          axis_avg_buffer_4_s_axi_aclk_i,
  input  wire          axis_avg_buffer_4_s_axi_aresetn,
  ...
  input  wire          axis_avg_buffer_4_s_axis_aclk_i,
  input  wire          axis_avg_buffer_4_s_axis_aresetn,
  input  wire          axis_avg_buffer_4_m_axis_aclk_i,
  input  wire          axis_avg_buffer_4_m_axis_aresetn,
  ...
  input  wire          axis_avg_buffer_5_s_axi_aclk_i,
  input  wire          axis_avg_buffer_5_s_axi_aresetn,
  ...
  input  wire          axis_avg_buffer_5_s_axis_aclk_i,
  input  wire          axis_avg_buffer_5_s_axis_aresetn,
  input  wire          axis_avg_buffer_5_m_axis_aclk_i,
  input  wire          axis_avg_buffer_5_m_axis_aresetn,
  ...
  input  wire          axis_avg_buffer_6_s_axi_aclk_i,
  input  wire          axis_avg_buffer_6_s_axi_aresetn,
  ...
  input  wire          axis_avg_buffer_6_s_axis_aclk_i,
  input  wire          axis_avg_buffer_6_s_axis_aresetn,
  input  wire          axis_avg_buffer_6_m_axis_aclk_i,
  input  wire          axis_avg_buffer_6_m_axis_aresetn,
  ...
  input  wire          axis_signal_gen_v6_1_s_axi_aclk_i,
  ...
  input  wire          axis_signal_gen_v6_1_s0_axis_aclk_i,
  ...
  input  wire          axis_signal_gen_v6_1_aclk_i,
  ...
  AxisAvgBuffer_2 axis_avg_buffer_2 (
    ...
    .s_axi_aclk_i   (axis_avg_buffer_2_s_axi_aclk_i         ), //i
    .s_axi_aresetn  (axis_avg_buffer_2_s_axi_aresetn        ), //i
    ...
    .s_axis_aclk_i  (axis_avg_buffer_2_s_axis_aclk_i        ), //i
    .s_axis_aresetn (axis_avg_buffer_2_s_axis_aresetn       ), //i
    .m_axis_aclk_i  (axis_avg_buffer_2_m_axis_aclk_i        ), //i
    .m_axis_aresetn (axis_avg_buffer_2_m_axis_aresetn       ), //i
  ...
  AxisAvgBuffer_2 axis_avg_buffer_3 (
    ...
    .s_axi_aclk_i   (axis_avg_buffer_3_s_axi_aclk_i         ), //i
    .s_axi_aresetn  (axis_avg_buffer_3_s_axi_aresetn        ), //i
    ...
    .s_axis_aclk_i  (axis_avg_buffer_3_s_axis_aclk_i        ), //i
    .s_axis_aresetn (axis_avg_buffer_3_s_axis_aresetn       ), //i
    .m_axis_aclk_i  (axis_avg_buffer_3_m_axis_aclk_i        ), //i
    .m_axis_aresetn (axis_avg_buffer_3_m_axis_aresetn       ), //i
  ...
  AxisAvgBuffer_2 axis_avg_buffer_4 (
    ...
    .s_axi_aclk_i   (axis_avg_buffer_4_s_axi_aclk_i         ), //i
    .s_axi_aresetn  (axis_avg_buffer_4_s_axi_aresetn        ), //i
    ...
    .s_axis_aclk_i  (axis_avg_buffer_4_s_axis_aclk_i        ), //i
    .s_axis_aresetn (axis_avg_buffer_4_s_axis_aresetn       ), //i
    .m_axis_aclk_i  (axis_avg_buffer_4_m_axis_aclk_i        ), //i
    .m_axis_aresetn (axis_avg_buffer_4_m_axis_aresetn       ), //i
  ...
  AxisAvgBuffer_2 axis_avg_buffer_5 (
    ...
    .s_axi_aclk_i   (axis_avg_buffer_5_s_axi_aclk_i         ), //i
    .s_axi_aresetn  (axis_avg_buffer_5_s_axi_aresetn        ), //i
    ...
    .s_axis_aclk_i  (axis_avg_buffer_5_s_axis_aclk_i        ), //i
    .s_axis_aresetn (axis_avg_buffer_5_s_axis_aresetn       ), //i
    .m_axis_aclk_i  (axis_avg_buffer_5_m_axis_aclk_i        ), //i
    .m_axis_aresetn (axis_avg_buffer_5_m_axis_aresetn       ), //i
  ...
  AxisAvgBuffer axis_avg_buffer_6 (
    ...
    .s_axi_aclk_i   (axis_avg_buffer_6_s_axi_aclk_i         ), //i
    .s_axi_aresetn  (axis_avg_buffer_6_s_axi_aresetn        ), //i
    ...
    .s_axis_aclk_i  (axis_avg_buffer_6_s_axis_aclk_i        ), //i
    .s_axis_aresetn (axis_avg_buffer_6_s_axis_aresetn       ), //i
    .m_axis_aclk_i  (axis_avg_buffer_6_m_axis_aclk_i        ), //i
    .m_axis_aresetn (axis_avg_buffer_6_m_axis_aresetn       ), //i
  ...
  AxisSignalGenV6 axis_signal_gen_v6_0 (
    .s_axi_aclk_i    (axis_signal_gen_v6_0_s_axi_aclk_i         ), //i
    .s_axi_aresetn   (axis_signal_gen_v6_0_s_axi_aresetn        ), //i
    ...
    .s0_axis_aclk_i  (axis_signal_gen_v6_0_s0_axis_aclk_i       ), //i
    .s0_axis_aresetn (axis_signal_gen_v6_0_s0_axis_aresetn      ), //i
    ...
    .aresetn         (axis_signal_gen_v6_0_aresetn              ), //i
    .aclk_i          (axis_signal_gen_v6_0_aclk_i               ), //i
  ...
  AxisSignalGenV6_1 axis_signal_gen_v6_1 (
    .s_axi_aclk_i    (axis_signal_gen_v6_1_s_axi_aclk_i         ), //i
    ...
    .s0_axis_aclk_i  (axis_signal_gen_v6_1_s0_axis_aclk_i       ), //i
    ...
    .aclk_i          (axis_signal_gen_v6_1_aclk_i               ), //i
